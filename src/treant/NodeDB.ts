...
export class NodeDB {
  ...
  reset(nodeStructure: any, tree: any) {
    ...
    console.log(`after iterateChildren`);
    console.log(this.db);
  ...
  createGeometries(tree: any) {
    ...
    console.log(`this.db.length ${this.db.length}`);
